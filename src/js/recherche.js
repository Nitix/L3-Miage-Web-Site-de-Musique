            ...
            */
            ...
            function addToPlaylist(track_id,track_title,track_artist){
                ...
                $("#playlistsPopup").offset({ top: y, left: ( currentMousePos.x - $("#playlistsPopup").width() - 20) });
            ...
            function addNewPlaylistInPopup(){
                    ...
                    $("#createPlaylistLi").animate({backgroundColor: "#2E2E2E"}, 1);
                        ...
                        $("#submitNewPlaylistBtn").click(function(){
                            ...
                            if(!noNameYet){
                                if(alreadyExists)
                                {
                                    ...
                                    noNameYet = true;
                                    $("#createPlaylistLi").animate({backgroundColor: "#DE3F2A"}, 1);
